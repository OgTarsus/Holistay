        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 relative">
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between border-b border-gray-100 pb-10">
              ...
              <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden border-2 border-primary/20 shadow-lg">
                <img src={listing.host.avatar} className="w-full h-full object-cover" alt={listing.host.name} />
              </div>
            </div>

            <section className="space-y-8 border-b border-gray-100 pb-10 mb-10 text-gray-700 italic font-medium leading-relaxed">
               {listing.description}
            </section>

            <section className="space-y-8 border-b border-gray-100 pb-10 mb-10">
            ...
            <section className="pb-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 max-w-xl">
                 <AmenityItem icon={<Wifi className="w-6 h-6" />} label="Premium high-speed wifi" />
                 <AmenityItem icon={<Utensils className="w-6 h-6" />} label="Gourmet designer Kitchen" />
                 <AmenityItem icon={<Car className="w-6 h-6" />} label="Complimentary valet parking" />
                 <AmenityItem icon={<Dog className="w-6 h-6" />} label="Bespoke pet services" />
                 <AmenityItem icon={<Tv className="w-6 h-6" />} label="Smart display cinematic system" />
                 <AmenityItem icon={<Waves className="w-6 h-6" />} label="Private heated pool" cross={!listing.amenities.includes('Pool')} />
              </div>
              <Link 
                to="/"
                className="inline-block mt-12 px-8 py-4 border-2 border-gray-900 rounded-2xl font-black hover:bg-gray-900 hover:text-white transition-all active:scale-95 shadow-xl shadow-gray-100"
              >
                Show all amenities
              </Link>
            </section>
